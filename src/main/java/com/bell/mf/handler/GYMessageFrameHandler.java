...
public class GYMessageFrameHandler extends AbstractMessageFrameHandler implements MessageFrameHandler{
	...
	public void handler(String deviceId, IMessageFrame iMessageFrame, String message) {
		System.out.println("4401..............");
	}
	@CommandCode(value="4402")
	public void heart(IMessageFrame iMessageFrame, String message) {
		System.out.println("4401..............");
	}
	@CommandCode(value={"4403","4404"})
